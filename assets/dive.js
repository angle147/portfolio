...
(function () {
  ...
  var CD1 = [255, 255, 255], CD2 = [25, 42, 33];        // --card (rgba)
  var CA1 = 0.55, CA2 = 0.5;                            // --card alpha
  var BD1 = [90, 130, 90], BD2 = [175, 205, 175];       // --border (rgba)
  var BA1 = 0.3, BA2 = 0.25;                            // --border alpha
  var TX1 = [51, 71, 58], TX2 = [205, 215, 200];        // --text
  var TS1 = [31, 51, 39], TS2 = [240, 246, 238];        // --text-strong
  var MU1 = [109, 127, 104], MU2 = [150, 168, 150];     // --muted
  var AC1 = [62, 125, 70], AC2 = [130, 200, 140];       // --accent
  ...
  function paint() {
    ...
    set('--text', [lerp(TX1[0], TX2[0], e), lerp(TX1[1], TX2[1], e), lerp(TX1[2], TX2[2], e)]);
    set('--text-strong', [lerp(TS1[0], TS2[0], e), lerp(TS1[1], TS2[1], e), lerp(TS1[2], TS2[2], e)]);
    set('--muted', [lerp(MU1[0], MU2[0], e), lerp(MU1[1], MU2[1], e), lerp(MU1[2], MU2[2], e)]);
    set('--accent', [lerp(AC1[0], AC2[0], e), lerp(AC1[1], AC2[1], e), lerp(AC1[2], AC2[2], e)]);
